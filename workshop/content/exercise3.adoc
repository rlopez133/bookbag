...
resource-quota  20s   requests.cpu=1,requests.memory=1Gi      limits.cpu=2,limits.memory=2Gi
----
+
. Congratulations! You now have completed Exercise 3 of applying resource quotas to newly created namespaces within an OpenShift cluster.
