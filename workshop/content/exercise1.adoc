...
Below you'll find a flow diagram representation of the Ansible Playbook and the
Ansible Playbook itself.

.Ansible Playbook Flowdiagram
image::images/images/exercise1_flow.png[link="images/exercise1_flow.png",window="_blank"]
